...
CREATE TABLE monitoring_penanaman (
  ...
  waktu_tanam DATE,
  jarak_tanam TEXT, 
  kategori_tanaman TEXT CHECK (kategori_tanaman IN ('tanaman utama','pohon penaung', 'tanaman lainnya')),
  jenis_tanaman text,
  nama_ilmiah text,
  sumber_bibit TEXT CHECK (sumber_bibit IN ('bibit sertifikat', 'non sertifikat', 'lainnya')),
  usia_tanaman INT,
